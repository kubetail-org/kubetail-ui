...
const FormCheck = React.forwardRef(({ as = 'input', className, id, label, ...props }, ref) => {
    ...
    return (React.createElement("div", { className: cn(wrapperBaseCls, className) },
        React.createElement(Tag, { ...props, ref: ref, id: id, type: "checkbox", className: inputBaseCls }),
        label && (React.createElement("label", { htmlFor: id, className: labelBaseCls }, label))));
});
