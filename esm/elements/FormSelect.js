...
const FormSelect = React.forwardRef(({ className, id, ...props }, ref) => {
    const { controlId } = useContext(FormGroupContext);
    return (React.createElement("select", { ...props, ref: ref, id: id || controlId, className: cn(baseCls, className) }));
});
