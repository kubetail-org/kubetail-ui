...
const Form = forwardRef(({ className, ...props }: React.ComponentPropsWithoutRef<'form'>, ref: React.ForwardedRef<HTMLFormElement>) => <form {...props} ref={ref} className={cn(baseCls, className)} />)
