...
const Header = (_a) => {
    var { className, sortBy, onSortByChange } = _a, props = __rest(_a, ["className", "sortBy", "onSortByChange"]);
    const value = {
        sortBy: sortBy || null,
    ...
    return (react_1.default.createElement(exports.Context.Provider, { value: context },
        react_1.default.createElement("thead", Object.assign({}, props, { className: (0, utils_1.cn)(baseCls, className) }))));
};
