...
const FormSelect = react_1.default.forwardRef((_a, ref) => {
    var { className, id } = _a, props = __rest(_a, ["className", "id"]);
    const { controlId } = (0, react_1.useContext)(FormGroup_js_1.Context);
    return (react_1.default.createElement("select", Object.assign({}, props, { ref: ref, id: id || controlId, className: (0, utils_1.cn)(baseCls, className) })));
});
